...
import dev.radmacher.rebootcore.gui.events.GuiClickEvent;
...
public class DoubleGui extends Gui {
    ...
    @Override
    public DoubleGui updateItem(int row, int col, Material itemTo, String title, String... lore) {
        return (DoubleGui) super.updateItem(col + row * 9, itemTo, title, lore);
    }

    @Override
    public DoubleGui updateItem(int cell, Material itemTo, String title, String... lore) {
        return (DoubleGui) super.updateItem(cell, itemTo, title, lore);
    }
    ...
    @Override
    public DoubleGui updateItem(int row, int col, Material itemTo, String title, List<String> lore) {
        return (DoubleGui) super.updateItem(col + row * 9, itemTo, title, lore);
    }

    @Override
    public DoubleGui updateItem(int cell, Material itemTo, String title, List<String> lore) {
        return (DoubleGui) super.updateItem(cell, itemTo, title, lore);
    }
