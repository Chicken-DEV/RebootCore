...
import dev.radmacher.rebootcore.compatibility.CompatibleSound;
...
public class GuiManager {
    ...
    public void showPopup(Player player, String message) {
        showPopup(player, message, Material.NETHER_STAR, BackgroundType.ADVENTURE);
    }

    public void showPopup(Player player, String message, Material icon) {
        showPopup(player, message, icon, BackgroundType.ADVENTURE);
    }

    public void showPopup(Player player, String message, Material icon, BackgroundType background) {
