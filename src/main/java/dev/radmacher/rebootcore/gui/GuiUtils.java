...
public class GuiUtils {
    ...
    public static ItemStack createButtonItem(Material mat, int amount, String title, String... lore) {
        ItemStack item = new ItemStack(mat);
    ...
    public static ItemStack createButtonItem(Material mat, int amount, String title, List<String> lore) {
        ItemStack item = new ItemStack(mat);
        item.setAmount(amount);
        ItemMeta meta = item.getItemMeta();
        if (meta != null) {
    ...
    public static ItemStack createButtonItem(Material mat, String[] lore) {
        ItemStack item = new ItemStack(mat);
        ItemMeta meta = item.getItemMeta();
        if (meta != null) {
    ...
    public static ItemStack createButtonItem(Material mat, int amount, String[] lore) {
        ItemStack item = new ItemStack(mat);
        item.setAmount(amount);
        ItemMeta meta = item.getItemMeta();
        if (meta != null) {
    ...
    public static ItemStack createButtonItem(Material mat, List<String> lore) {
        ItemStack item = new ItemStack(mat);
        ItemMeta meta = item.getItemMeta();
        if (meta != null) {
    ...
    public static ItemStack createButtonItem(Material mat, int amount, List<String> lore) {
        ItemStack item = new ItemStack(mat);
        item.setAmount(amount);
        ItemMeta meta = item.getItemMeta();
        if (meta != null) {
    ...
    public static ItemStack updateItem(ItemStack item, Material matTo, String title, String... lore) {
        if (!matTo.equals(item.getType())) {
            item = new ItemStack(matTo);
        }
        ItemMeta meta = item.getItemMeta();
        if (meta != null) {
            meta.setDisplayName(title);
    ...
    public static ItemStack updateItem(ItemStack item, ItemStack to, String title, String... lore) {
        if (!item.getType().equals(to.getType())) {
            item = to.clone();
        }
        ItemMeta meta = item.getItemMeta();
        if (meta != null) {
    ...
    public static ItemStack updateItem(ItemStack item, Material matTo, String title, List<String> lore) {
        if (!matTo.equals(item.getType())) {
            item = new ItemStack(matTo);
        }
        ItemMeta meta = item.getItemMeta();
