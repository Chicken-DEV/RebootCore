package dev.radmacher.rebootcore.locale;
...
public class Message {
    ...
    /*public void sendActionBar(CommandSender sender) {
        if (!(sender instanceof Player)) {
            ...
            sender.sendMessage(ChatMessageType.ACTION_BAR, TextComponent.toPlainText(getMessage()));
            ((Player) sender).sendMessage(net.md_5.bungee.api.ChatMessageType.ACTION_BAR,
